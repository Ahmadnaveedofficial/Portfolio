    ...
    <AnimatePresence>
        {showSuccess && (
            ...
            >
                ...
                className={`relative p-8 rounded-2xl border max-w-sm w-full text-center ${isDarkMode ? "bg-gray-800 border-gray-700": 
                ...
                >
                    ...
                    >
                          ...
                          >
                            Thank you for reaching out! I will get back to you witin 24 hours.
                          </motion.p>
                          <motion.div 
